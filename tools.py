...
def generate_life_insurance_data_extended(num_records):
    data = {
        "Age": [],
        "BMI": [],
        "ZIP Code": [],
    ...
    zip_codes = [
        "10001", "90210", "60601", "30301", "80201", 
        "33101", "02101", "94101", "70112", "75201"
    ]
    ...
    occupations = ["Engineer", "Teacher", "Doctor", "Lawyer", "Salesperson", "Retired", "Student", "Unemployed"]
    health_classes = ["Preferred", "Standard", "Substandard"]
    ...
    for i in range(num_records):
        ...
        # Randomly assign an occupation and health class
        occupation = random.choice(occupations)
        health_class = random.choice(health_classes)
        ...
        data["Policy Type"].append(policy_type)
        ...
        data["Health Class"].append(health_class)
...
# Example usage:
life_insurance_data = generate_life_insurance_data_extended(1000)
print(life_insurance_data.head())
